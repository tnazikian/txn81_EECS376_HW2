...
double angle_min_=-0.03;
double angle_max_=0.03;
double angle_increment_=0.007;
...
void laserCallback(const sensor_msgs::LaserScan& laser_scan) {
        ...
        ping_index_start = (int)((1.57 -angle_max_)/angle_increment_);
        ping_index_end = (int)((1.57 -angle_min_)/angle_increment_);
